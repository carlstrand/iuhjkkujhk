...
define([
     ...
     */
    $.widget('mage.cleverSwatchRendererTooltip', {
        options: {
     ...
     */
    $.widget('mage.cleverSwatchRenderer', {
        options: {
            classes: {
        ...
        _init: function () {
            if (this.options.jsonConfig !== '' && this.options.jsonSwatchConfig !== '') {
                ...
                console.log('cleverSwatchRenderer: No input data received');
            }
        },
        ...
        _create: function () {
            var options = this.options,
                ...
                isProductViewExist = $('.gallery-placeholder').size() > 0,
        ...
        _LoadProductMedia: function () {
            ...
            if ($this.closest("#product_addtocart_form").find("input[name=product]").length){
                productId = $this.closest("#product_addtocart_form").find("input[name=product]").val();
            }else if ($('body.catalog-product-view').size() > 0) {
                //Product Page
        ...
        updateBaseImage: function (images, context, isProductViewExist) {
            ...
            if (this.options.isStickyLayout) {
                var deiv = context.find('.product-img-column ' + this.options.galleryStickyDiv);
                var html = '';
                $.each( images, function( key, item ) {
                    html += "<div class='gallery-sticky2-image-thumb-wrapper'>";
                    html += "<a href='" + item.full + "'><img src='" + item.img +"'/></a>";
                    html += "</div>";
                });
                deiv.html(html);
            }
    ...
    return $.mage.cleverSwatchRenderer;
});
